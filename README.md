...
- Logout and login for extension to install
...
If you are interested in translating, download the [po file](https://github.com/MedievalApple/media-controls/blob/main/assets/locale/mediacontrols%40medievalapple.net.pot) and translate it. Then open a pull request with the translated file. You can use [Gtranslator](https://flathub.org/apps/org.gnome.Gtranslator) or [Poedit](https://flathub.org/apps/net.poedit.Poedit) to translate.
